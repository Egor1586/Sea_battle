...
def menu():
    ...
    im_coin_holder = pygame.image.load(
        os.path.abspath(os.path.join(__file__, "..", "..", "..", "image", "coins", "coin_holder2.png"))
    )
    im_coin_holder = pygame.transform.scale(im_coin_holder, [375, 75])

    bg = pygame.image.load(
        os.path.abspath(os.path.join(__file__, "..", "..", "..", "image", "bg", "background.png"))
    )
